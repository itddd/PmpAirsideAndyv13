...
<div id="header">
    <header id="header2">
        <div class="container">
  <?php if ($logo) { ?>
  <div class="logo"><a href="http://www.raiiar.co.uk/porsche/index.php?route=product/category&path=57"><img src="img/logo.png" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" /></a></div>
  <?php } ?>
...
<!-- ============ J.O. 16-JUN-2013 Ensure Menu items with SubMenu HREF=# & SubMenu Categories have (0) removed ============= -->
<!-- ====== Navigaion Menu ====== -->
            <!-- Nav -->
            <nav id="nav">
                <ul class="sf-menu movement">
        <li><a href="http://www.raiiar.co.uk/porsche/index.php?route=product/category&amp;path=57">HOME</a>
          </li>
        <li><a href="http://www.raiiar.co.uk/porsche/index.php?route=product/category&amp;path=33">ABOUT US</a>
          </li>
        <li><a>MASSAGES</a>
            <div>
                <ul>
                                        <li><a href="http://www.raiiar.co.uk/porsche/index.php?route=product/category&amp;path=20_27">ALL ABOUT ME</a></li>
                                        <li><a href="http://www.raiiar.co.uk/porsche/index.php?route=product/category&amp;path=20_26">YUMMY MUMMY</a></li>
                            </ul>
              </div>
          </li>
        <li><a href="http://www.raiiar.co.uk/porsche/index.php?route=product/category&amp;path=17">CORPORATE</a>
          </li>
        <li><a href="http://www.raiiar.co.uk/porsche/index.php?route=product/category&amp;path=25">BOOK NOW</a>
          </li>
        <li><a href="http://www.raiiar.co.uk/porsche/index.php?route=product/category&amp;path=24">CONTACT US</a>
          </li>
                    </ul>
            </nav>
            <!-- /Nav -->
