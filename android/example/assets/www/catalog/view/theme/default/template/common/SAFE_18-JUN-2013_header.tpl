...
<!-- ====== Navigaion Menu ====== -->
        ...
        <li><a href="http://www.palm-therapies.com/index.php?route=product/category&amp;path=57">HOME</a>
          </li>
        <li><a href="http://www.palm-therapies.com/index.php?route=product/category&amp;path=33">ABOUT US</a>
          </li>
        <li><a>MASSAGES</a>
            <div>
                <ul>
                                        <li><a href="http://www.palm-therapies.com/index.php?route=product/category&amp;path=20_27">ALL ABOUT ME</a></li>
                                        <li><a href="http://www.palm-therapies.com/index.php?route=product/category&amp;path=20_26">YUMMY MUMMY</a></li>
                            </ul>
              </div>
          </li>
        <li><a href="http://www.palm-therapies.com/index.php?route=product/category&amp;path=17">CORPORATE</a>
          </li>
        <li><a href="http://www.palm-therapies.com/index.php?route=product/category&amp;path=25">BOOK NOW</a>
          </li>
        <li><a href="http://www.palm-therapies.com/index.php?route=product/category&amp;path=24">CONTACT US</a>
          </li>
                    </ul>
            </nav>
            <!-- /Nav -->
